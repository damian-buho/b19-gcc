...
Дякуємо, що користуєтеся **B19/GCC**!
Цей документ пояснює, де шукати допомогу та як ставити зрозумілі запитання.

## Куди звертатися

- **Повідомити про відтворювану ваду** — [Issues on Codeberg](https://codeberg.org/b19/gcc/issues)
- **Повідомити про відтворювану ваду** — [Issues on GitHub](https://github.com/damian-buho/b19-gcc/issues)
...
4. **Середовище** — операційна система, версія B19/GCC, версія середовища виконання.
