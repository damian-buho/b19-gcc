...
- Para ver si otras personas han tenido (y quizá ya resuelto) el mismo problema, comprueba que no exista ya un informe de tu fallo o error en el [gestor de incidencias](https://github.com/damian-buho/b19-gcc/issues?q=label%3Abug).
...
Usamos [Issues de GitHub](https://github.com/damian-buho/b19-gcc/issues) para seguir fallos y errores. Si te topas con un problema en el proyecto:

- Abre una [incidencia](https://github.com/damian-buho/b19-gcc/issues/new). (Como todavía no podemos saber si se trata de un fallo, te pedimos que no lo des por hecho ni etiquetes la incidencia.)
...
- Haz una [búsqueda](https://github.com/damian-buho/b19-gcc/issues) para ver si ya se ha propuesto. Si es así, comenta en la incidencia existente en lugar de abrir una nueva.
- Valora si tu idea encaja con el alcance y los objetivos del proyecto.

<!-- omit in toc -->
### ¿Cómo envío una buena propuesta de mejora?

Las propuestas de mejora se gestionan como Issues de GitHub.
...
- **Explica por qué esta mejora sería útil** para quienes usan B19 / GCC. También puedes señalar otros proyectos que lo hayan resuelto mejor y que sirvan de inspiración.
