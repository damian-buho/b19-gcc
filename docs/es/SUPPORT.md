...
¡Gracias por usar **B19/GCC**!
Este documento explica dónde conseguir ayuda y cómo formular buenas preguntas.

## Dónde preguntar

- **Informar de un fallo reproducible** — [Issues on Codeberg](https://codeberg.org/b19/gcc/issues)
- **Informar de un fallo reproducible** — [Issues on GitHub](https://github.com/damian-buho/b19-gcc/issues)
...
Para que podamos ayudarte, incluye:
...
4. **Entorno** — sistema operativo, versión de B19/GCC, versión del entorno de ejecución.
5. **Un ejemplo mínimo reproducible**, si es posible.

Consulta la [guía MCVE de Stack Overflow](https://stackoverflow.com/help/minimal-reproducible-example)
para más consejos.
